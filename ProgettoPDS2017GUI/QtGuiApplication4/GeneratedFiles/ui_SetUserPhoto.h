...
{
public:
    QPushButton *SetPhotoNextButton;
    ...
    void setupUi(QWidget *SetUserPhoto)
    {
        ...
        SetUserPhoto->resize(261, 261);
        SetPhotoNextButton = new QPushButton(SetUserPhoto);
        SetPhotoNextButton->setObjectName(QStringLiteral("SetPhotoNextButton"));
        SetPhotoNextButton->setGeometry(QRect(150, 220, 81, 23));
        UserPhotoLabel = new QLabel(SetUserPhoto);
        UserPhotoLabel->setObjectName(QStringLiteral("UserPhotoLabel"));
        UserPhotoLabel->setGeometry(QRect(20, 9, 221, 41));
        ...
        SetPhotoChooseButton->setGeometry(QRect(30, 220, 81, 23));
        UserPhotoImage = new QLabel(SetUserPhoto);
        UserPhotoImage->setObjectName(QStringLiteral("UserPhotoImage"));
        UserPhotoImage->setGeometry(QRect(60, 60, 141, 141));
        UserPhotoImage->setPixmap(QPixmap(QString::fromUtf8(":/new/prefix1/DefaultUser")));
    ...
    void retranslateUi(QWidget *SetUserPhoto)
    {
        ...
        SetPhotoNextButton->setText(QApplication::translate("SetUserPhoto", "Next", nullptr));

...
QT_MOC_LITERAL(1, 13, 15), // "SenderException"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9) // "exception"

    },
    "SenderThread\0SenderException\0\0exception"
};
...
void SenderThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SenderException((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (SenderThread::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SenderThread::SenderException)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SenderThread::SenderException(QString _t1)
{
